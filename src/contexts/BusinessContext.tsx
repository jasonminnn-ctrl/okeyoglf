...
const baseBannerMessages: Record<string, string> = {
  "대시보드": "현재 업종 기준 핵심 운영 현황",
  "AI 비서": "현재 업종과 운영 프로필을 바탕으로 추천",
  "AI 운영팀": "현재 업종 운영 기준에 맞는 관리 항목",
  "AI 영업팀": "현재 업종 고객/판매 구조 기준 제안",
  "AI 마케팅팀": "현재 업종 마케팅/프로모션 기준 추천",
  "AI 디자인팀": "현재 업종 홍보물/디자인 요청 기준",
  "AI 경영지원": "현재 업종 문서/운영지원 기준",
  "시장조사": "현재 업종과 지역 기준 조사 예시",
  "전담 컨설턴트": "현재 업종 전문 컨설팅 요청 기준",
};
